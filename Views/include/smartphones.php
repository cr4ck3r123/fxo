...
if (empty($id)) {
    ...
    include_once("./Dao/dao-smartphone.php");
...
//pega a quantidade total de objetos no banco de dados
    $num_total = listarSmartphonesTotal();
    ...
    <section class="section section-md bg-default section-top-image">
        <div class="container">
            <div class="row row-30 justify-content-center">
                <?php foreach (listarSmartphones($inicio, $itens_por_pagina) as $row): ?>
...
//verificar a pagina anterior e posterior
    ...
    $url = $_GET['url'];
    $id = $_POST['tipo'];
    $eletronico = recuperaDadosEletronicos($id);
    ?>
