...
<html class="wide wow-animation" lang="en">
    <head>
       ...
       <meta property="og:image" content="https://fxoeletronicos.ddns.net/images/logo-default-196x47.png" />
                        ...
                        <div class="rd-navbar-main-outer" style="background-color: #2b2a28;">
                            <div class="rd-navbar-main">
                                ...
                                <div class="rd-navbar-panel" style="background-color: #2b2a28;">
                                    ...
                                    <!-- RD Navbar Brand-->
                                    <div class="rd-navbar-brand"><a title="Ir para a Página Inicial" class="brand" href="/"><img src="images/logo-default-196x47.png" alt="" width="196" height="47"/></a></div>
                                </div>
                                    ...
                                    <div class="rd-navbar-nav-wrap">
                                        ...
                                        <ul class="rd-navbar-nav">
                                            ...
                                            if (!isset($_SESSION['nome_usuario'])) {
                                                ...
                                                echo ' <li class="rd-nav-item"><a class="rd-nav-link"  href="login">Login</a>
                                                         </li>';
                                            }
                                            ?>
