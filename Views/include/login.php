...
<head>
    <title>LFA ELetronicos - Login</title>
    <meta name="format-detection" content="telephone=no">
    <meta name="viewport" content="width=device-width, height=device-height, initial-scale=1.0, maximum-scale=1.0, user-scalable=0">

    <meta http-equiv="content-type" content="text/html;charset=utf-8" />
    <meta name="description" content="A maior loja de eletronicos da america latina">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4 login-sec">
                    ...
                    <form class="login100-form validate-form" method="post" action="../Control/autenticar.php">
                        ...
                        <div id="demo" class="carousel slide carousel-fade" data-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel active">
                                    <a href="./"> <img src="../images/banner/promocao1.png" height="100%" width="100%"> </a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#btn-cadastro').click(function (event) {
            ...
            $('#text-sucess').removeClass();
            $('#mensagem').val('');
            $.ajax({
                url: "../Dao/dao-usuario.php",
                method: "post",
                data: $('form').serialize(),
                dataType: "text",
