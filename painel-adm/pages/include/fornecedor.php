<?php
include_once('Dao/dao-fornecedor.php');
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <table class="table table-hover">
                ...
                <tbody align="width">
                    <?php  foreach (listarFornecedor($inicio, $itens_por_pagina) as $row): ?>
                    <tr>     
                        <td style="width: 3%"><?php echo $row['id']."<br>";    ?></td> 
                        <td style="width: 35%"><?php echo $row['empresa']."<br>";    ?></td> 
                        <td style="width: 45%"><?php echo $row['contato_pessoa']."<br>";    ?></td> 
                        <td style="width: 85%"><?php echo $row['telefone']."<br>";    ?></td> 
